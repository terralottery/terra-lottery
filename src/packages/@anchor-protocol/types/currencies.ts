...
export type uMIR<T = string> = T & NominalType<"umir">
export type MIR<T = string> = T & NominalType<"mir">
...
export type uCW20Token<T = string> = T &
  NominalType<
    "uaust" | "uanc" | "umir" | "ubluna" | "uanc_ust_lp" | "ubluna_luna_lp"
  >

export type CW20Token<T = string> = T &
  NominalType<"aust" | "anc" | "mir" | "bluna" | "anc_ust_lp" | "bluna_luna_lp">
